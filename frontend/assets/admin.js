...
async function uploadToBunny(file, bunny, title) {
    return new Promise((resolve, reject) => {
        ...
        xhr.open('POST', bunny.uploadUrl);
        xhr.setRequestHeader('AccessKey', bunny.apiKey);
        xhr.setRequestHeader('LibraryId',  bunny.libraryId);
        xhr.setRequestHeader('VideoId',    bunny.videoId);
        xhr.setRequestHeader('FileName',   encodeURIComponent(title));
        ...
        <div class="section-card">
            ...
            <div style="display:flex;align-items:center;gap:12px">
                ...
                <label style="display:flex;align-items:center;gap:7px;font-size:12px;color:var(--muted);cursor:pointer">
                    <input type="checkbox" id="adActive_${ad.slot_key}" ${ad.i
